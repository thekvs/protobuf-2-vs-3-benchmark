...
#ifndef PROTOBUF_message_2fv3_2fmessage_2eproto__INCLUDED
#define PROTOBUF_message_2fv3_2fmessage_2eproto__INCLUDED
...
class Record : public ::google::protobuf::Message {
 public:
  ...
  // @@protoc_insertion_point(class_scope:protobuf_v3_benchmark.Record)
 private:
  ...
  friend void  protobuf_AddDesc_message_2fv3_2fmessage_2eproto();
  friend void protobuf_AssignDesc_message_2fv3_2fmessage_2eproto();
  friend void protobuf_ShutdownFile_message_2fv3_2fmessage_2eproto();
...
inline ::google::protobuf::int64 Record::i(int index) const {
  // @@protoc_insertion_point(field_get:protobuf_v3_benchmark.Record.i)
  return i_.Get(index);
}
inline void Record::set_i(int index, ::google::protobuf::int64 value) {
  i_.Set(index, value);
  // @@protoc_insertion_point(field_set:protobuf_v3_benchmark.Record.i)
}
inline void Record::add_i(::google::protobuf::int64 value) {
  i_.Add(value);
  // @@protoc_insertion_point(field_add:protobuf_v3_benchmark.Record.i)
}
inline const ::google::protobuf::RepeatedField< ::google::protobuf::int64 >&
Record::i() const {
  // @@protoc_insertion_point(field_list:protobuf_v3_benchmark.Record.i)
  return i_;
}
inline ::google::protobuf::RepeatedField< ::google::protobuf::int64 >*
Record::mutable_i() {
  // @@protoc_insertion_point(field_mutable_list:protobuf_v3_benchmark.Record.i)
  return &i_;
}
...
inline const ::std::string& Record::s(int index) const {
  // @@protoc_insertion_point(field_get:protobuf_v3_benchmark.Record.s)
  return s_.Get(index);
}
inline ::std::string* Record::mutable_s(int index) {
  // @@protoc_insertion_point(field_mutable:protobuf_v3_benchmark.Record.s)
  return s_.Mutable(index);
}
inline void Record::set_s(int index, const ::std::string& value) {
  // @@protoc_insertion_point(field_set:protobuf_v3_benchmark.Record.s)
  s_.Mutable(index)->assign(value);
}
inline void Record::set_s(int index, const char* value) {
  s_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:protobuf_v3_benchmark.Record.s)
}
inline void Record::set_s(int index, const char* value, size_t size) {
  s_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:protobuf_v3_benchmark.Record.s)
}
...
inline void Record::add_s(const ::std::string& value) {
  s_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:protobuf_v3_benchmark.Record.s)
}
inline void Record::add_s(const char* value) {
  s_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:protobuf_v3_benchmark.Record.s)
}
inline void Record::add_s(const char* value, size_t size) {
  s_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:protobuf_v3_benchmark.Record.s)
}
inline const ::google::protobuf::RepeatedPtrField< ::std::string>&
Record::s() const {
  // @@protoc_insertion_point(field_list:protobuf_v3_benchmark.Record.s)
  return s_;
}
inline ::google::protobuf::RepeatedPtrField< ::std::string>*
Record::mutable_s() {
  // @@protoc_insertion_point(field_mutable_list:protobuf_v3_benchmark.Record.s)
  return &s_;
}
...
inline ::google::protobuf::int32 Record::small_i(int index) const {
  // @@protoc_insertion_point(field_get:protobuf_v3_benchmark.Record.small_i)
  return small_i_.Get(index);
}
inline void Record::set_small_i(int index, ::google::protobuf::int32 value) {
  small_i_.Set(index, value);
  // @@protoc_insertion_point(field_set:protobuf_v3_benchmark.Record.small_i)
}
inline void Record::add_small_i(::google::protobuf::int32 value) {
  small_i_.Add(value);
  // @@protoc_insertion_point(field_add:protobuf_v3_benchmark.Record.small_i)
}
inline const ::google::protobuf::RepeatedField< ::google::protobuf::int32 >&
Record::small_i() const {
  // @@protoc_insertion_point(field_list:protobuf_v3_benchmark.Record.small_i)
  return small_i_;
}
inline ::google::protobuf::RepeatedField< ::google::protobuf::int32 >*
Record::mutable_small_i() {
  // @@protoc_insertion_point(field_mutable_list:protobuf_v3_benchmark.Record.small_i)
  return &small_i_;
}
...
inline double Record::d1(int index) const {
  // @@protoc_insertion_point(field_get:protobuf_v3_benchmark.Record.d1)
  return d1_.Get(index);
}
inline void Record::set_d1(int index, double value) {
  d1_.Set(index, value);
  // @@protoc_insertion_point(field_set:protobuf_v3_benchmark.Record.d1)
}
inline void Record::add_d1(double value) {
  d1_.Add(value);
  // @@protoc_insertion_point(field_add:protobuf_v3_benchmark.Record.d1)
}
inline const ::google::protobuf::RepeatedField< double >&
Record::d1() const {
  // @@protoc_insertion_point(field_list:protobuf_v3_benchmark.Record.d1)
  return d1_;
}
inline ::google::protobuf::RepeatedField< double >*
Record::mutable_d1() {
  // @@protoc_insertion_point(field_mutable_list:protobuf_v3_benchmark.Record.d1)
  return &d1_;
}
...
inline double Record::d2(int index) const {
  // @@protoc_insertion_point(field_get:protobuf_v3_benchmark.Record.d2)
  return d2_.Get(index);
}
inline void Record::set_d2(int index, double value) {
  d2_.Set(index, value);
  // @@protoc_insertion_point(field_set:protobuf_v3_benchmark.Record.d2)
}
inline void Record::add_d2(double value) {
  d2_.Add(value);
  // @@protoc_insertion_point(field_add:protobuf_v3_benchmark.Record.d2)
}
inline const ::google::protobuf::RepeatedField< double >&
Record::d2() const {
  // @@protoc_insertion_point(field_list:protobuf_v3_benchmark.Record.d2)
  return d2_;
}
inline ::google::protobuf::RepeatedField< double >*
Record::mutable_d2() {
  // @@protoc_insertion_point(field_mutable_list:protobuf_v3_benchmark.Record.d2)
  return &d2_;
}
...
#endif  // PROTOBUF_message_2fv3_2fmessage_2eproto__INCLUDED
